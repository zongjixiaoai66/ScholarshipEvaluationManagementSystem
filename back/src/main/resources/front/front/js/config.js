var projectName = '陕西理工大学奖学金评定管理系统';
/**
 * 轮播图配置
 */
var swiper = {
...
var centerMenu = [
    ...
    ,{
        name: '活动',
        url: '../huodong/list.html'
    }
    ,{
        name: '奖学金申请',
        url: '../jiangxuejinShenqing/list.html'
    }
    ,{
        name: '综合评测',
        url: '../zonghepingce/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/jiangxuejinpingding/admin/dist/index.html#/login";
