...
//                            laoshiEntity.setXueyuanTypes(Integer.valueOf(data.get(0)));   //学院 要改的
//                            laoshiEntity.setZhuanyeTypes(Integer.valueOf(data.get(0)));   //专业 要改的
//                            laoshiEntity.setJinyongTypes(Integer.valueOf(data.get(0)));   //账户状态 要改的
//                            laoshiEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(laoshi.getJinyongTypes() != 1)
