        ...
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.huodongContent"  label="活动介绍" prop="huodongContent">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="活动得奖" prop="huodongDejiangTypes">
                        <el-select v-model="ruleForm.huodongDejiangTypes" :disabled="ro.huodongDejiangTypes" placeholder="请选择活动得奖">
                            <el-option
                                v-for="(item,index) in huodongDejiangTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="活动得奖" prop="huodongDejiangValue">
                        <el-input v-model="ruleForm.huodongDejiangValue"
                            placeholder="活动得奖" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.huodongFile" label="附件" prop="huodongFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.huodongFile?$base.url+ruleForm.huodongFile:''"
                                @change="huodongFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.huodongFile" label="附件" prop="huodongFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.huodongFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   huodongDejiangTypes: [
                              { required: true, message: '活动得奖不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=huodong_dejiang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.huodongDejiangTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            //图片
            huodongFileUploadChange(fileUrls){
                this.ruleForm.huodongFile = fileUrls;
                this.addEditUploadStyleChange()
            },
