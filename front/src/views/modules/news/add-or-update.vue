    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="政策名称" prop="newsName">
                       <el-input v-model="ruleForm.newsName"
                                 placeholder="政策名称" clearable  :readonly="ro.newsName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="政策名称" prop="newsName">
                           <el-input v-model="ruleForm.newsName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.newsPhoto" label="政策图片" prop="newsPhoto">
                        <file-upload
                            tip="点击上传政策图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.newsPhoto" label="政策图片" prop="newsPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="政策类型" prop="newsTypes">
                        <el-select v-model="ruleForm.newsTypes" :disabled="ro.newsTypes" placeholder="请选择政策类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="政策类型" prop="newsValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.newsContent"  label="政策详情" prop="newsContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.newsContent" label="政策详情" prop="newsContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   newsPhoto: [
                              { required: true, message: '政策图片不能为空', trigger: 'blur' },
                          ],
                   newsTypes: [
                   ...
                   newsContent: [
                              { required: true, message: '政策详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
