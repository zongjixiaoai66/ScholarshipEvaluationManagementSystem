    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生成绩编号" prop="chengjiUuidNumber">
                       <el-input v-model="ruleForm.chengjiUuidNumber"
                                 placeholder="学生成绩编号" clearable  :readonly="ro.chengjiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学生成绩编号" prop="chengjiUuidNumber">
                           <el-input v-model="ruleForm.chengjiUuidNumber"
                                     placeholder="学生成绩编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生成绩名称" prop="chengjiName">
                       <el-input v-model="ruleForm.chengjiName"
                                 placeholder="学生成绩名称" clearable  :readonly="ro.chengjiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学生成绩名称" prop="chengjiName">
                           <el-input v-model="ruleForm.chengjiName"
                                     placeholder="学生成绩名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chengjiFile" label="附件" prop="chengjiFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.chengjiFile?$base.url+ruleForm.chengjiFile:''"
                                @change="chengjiFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chengjiFile" label="附件" prop="chengjiFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.chengjiFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩" prop="chengjiDefen">
                       <el-input v-model="ruleForm.chengjiDefen"
                                 placeholder="成绩" clearable  :readonly="ro.chengjiDefen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩" prop="chengjiDefen">
                           <el-input v-model="ruleForm.chengjiDefen"
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    xueshengId: '',
                    chengjiUuidNumber: new Date().getTime(),
                    chengjiName: '',
                    kemuTypes: '',
                    xuenianTypes: '',
                    xueqiTypes: '',
                ...
                rules: {
                   ...
                   chengjiUuidNumber: [
                              { required: true, message: '学生成绩编号不能为空', trigger: 'blur' },
                          ],
                   chengjiName: [
                              { required: true, message: '学生成绩名称不能为空', trigger: 'blur' },
                          ],
                   kemuTypes: [
        ...
        methods: {
            ...
            //图片
            chengjiFileUploadChange(fileUrls){
                this.ruleForm.chengjiFile = fileUrls;
                this.addEditUploadStyleChange()
            },
