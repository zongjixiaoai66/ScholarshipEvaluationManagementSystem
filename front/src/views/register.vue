    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">陕西理工大学奖学金评定管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                       ...
                       <!--<el-form-item class="input" label="学院">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.xueyuanTypes" placeholder="请选择学院">
                                <el-option
                       ...
                       <!--<el-form-item class="input" label="专业">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.zhuanyeTypes" placeholder="请选择专业">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // laoshi 中的 学院 判空处理
                            // if('laoshi' == this.tableName && (this.ruleForm.xueyuanTypes== null ||this.ruleForm.xueyuanTypes== "")){
                            //     this.$message.error("学院不能为空");
                            //     return
                            // }
                            // laoshi 中的 专业 判空处理
                            // if('laoshi' == this.tableName && (this.ruleForm.zhuanyeTypes== null ||this.ruleForm.zhuanyeTypes== "")){
                            ...
                            // xuesheng 中的 学院 判空处理
                            // if('xuesheng' == this.tableName && (this.ruleForm.xueyuanTypes== null ||this.ruleForm.xueyuanTypes== "")){
                            //     this.$message.error("学院不能为空");
                            //     return
                            // }
                            // xuesheng 中的 专业 判空处理
                            // if('xuesheng' == this.tableName && (this.ruleForm.zhuanyeTypes== null ||this.ruleForm.zhuanyeTypes== "")){
                            //     this.$message.error("专业不能为空");
                            //     return
                            // }
                            // xuesheng 中的 账户状态 判空处理
                            // if('xuesheng' == this.tableName && (this.ruleForm.jinyongTypes== null ||this.ruleForm.jinyongTypes== "")){
                            //     this.$message.error("账户状态不能为空");
                            //     return
                            // }
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/jiangxuejinpingding/img/back-img-bg.jpg);
